...
* Response:
  * `{"key":"9ace67495d403b56b473786bdc2c958d04fb7717"}`
...
* Request:  (Replace token string with logged in user's auth token)
  * `curl -X GET -H 'Authorization: Token 9ace67495d403b56b473786bdc2c958d04fb7717' localhost:8000/api/adv/init/`
* Response:
...
### Move
* Request:  (Replace token string with logged in user's auth token)
  * `curl -X POST -H 'Authorization: Token 9ace67495d403b56b473786bdc2c958d04fb7717' -H "Content-Type: application/json" -d '{"direction":"n"}' localhost:8000/api/adv/move/`
* Response:
...
* Request:  (Replace token string with logged in user's auth token)
  * `curl -X POST -H 'Authorization: Token 9ace67495d403b56b473786bdc2c958d04fb7717' -H "Content-Type: application/json" -d '{"message":"Hello, world!"}' localhost:8000/api/adv/say/`
* Pusher broadcast:
